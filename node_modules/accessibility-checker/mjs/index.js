 ...
 */
export function getCompliance(content, label, callback) {
    if (callback) {
 ...
 */
export function assertCompliance(report) {
 ...
 */
export function getDiffResults(label) {
 ...
 */
export function getBaseline(label) {
