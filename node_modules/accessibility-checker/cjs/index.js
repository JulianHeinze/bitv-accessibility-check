...
exports.ruleIdToLegacyId = void 0;
...
exports.getConfigUnsupported = getConfigUnsupported;
exports.close = close;
...
const ACBrowserManager_js_1 = require("./lib/ACBrowserManager.js");
const ACEngineManager_js_1 = require("./lib/ACEngineManager.js");
const ACHelper_js_1 = require("./lib/ACHelper.js");
const ACConfigManager_js_1 = require("./lib/common/config/ACConfigManager.js");
const BaselineManager_js_1 = require("./lib/common/report/BaselineManager.js");
const ReporterManager_js_1 = require("./lib/common/report/ReporterManager.js");
/**
 ...
 */
function getCompliance(content, label, callback) {
    if (callback) {
        (0, ACHelper_js_1.getComplianceHelper)(content, label)
            .then((result) => {
            callback(result.report, result.webdriver);
        });
    }
    else {
        return (0, ACHelper_js_1.getComplianceHelper)(content, label);
    }
}
/**
...
function assertCompliance(report) {
    return BaselineManager_js_1.BaselineManager.assertCompliance(report);
}
/**
...
function stringifyResults(report) {
    return ReporterManager_js_1.ReporterManager.stringifyResults(report);
}
function getConfig() {
    return ACConfigManager_js_1.ACConfigManager.getConfig();
}
function getConfigUnsupported() {
    return ACConfigManager_js_1.ACConfigManager.getConfigUnsupported();
}
function close() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            yield ReporterManager_js_1.ReporterManager.generateSummaries();
        }
        catch (err) {
            console.error(err);
        }
        return ACBrowserManager_js_1.ACBrowserManager.close();
    });
}
/**
...
function getDiffResults(label) {
    return BaselineManager_js_1.BaselineManager.getDiffResults(label);
}
/**
...
function getBaseline(label) {
    return BaselineManager_js_1.BaselineManager.getBaseline(label);
}
/**
...
function diffResultsWithExpected(actual, expected, clean) {
    return BaselineManager_js_1.BaselineManager.diffResultsWithExpected(actual, expected, clean);
}
/**
...
function cleanComplianceObjectBeforeCompare(objectToClean) {
    return BaselineManager_js_1.BaselineManager.cleanComplianceObjectBeforeCompare(objectToClean);
}
function addRuleset(ruleset) {
    ACEngineManager_js_1.ACEngineManager.addRuleset(ruleset);
}
function getRuleset(rsId) {
    return __awaiter(this, void 0, void 0, function* () {
        return ACEngineManager_js_1.ACEngineManager.getRuleset(rsId);
    });
}
;
function getRulesets() {
    return __awaiter(this, void 0, void 0, function* () {
        return ACEngineManager_js_1.ACEngineManager.getRulesets();
    });
}
;
function getRules() {
    return __awaiter(this, void 0, void 0, function* () {
        return ACEngineManager_js_1.ACEngineManager.getRules();
    });
}
